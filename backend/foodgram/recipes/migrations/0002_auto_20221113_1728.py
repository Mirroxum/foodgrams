...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='recipe',
            name='ingredients',
            field=models.ManyToManyField(null=True, to='recipes.AmountIngredient'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='ingredients',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='recipes.Ingredient', unique=True, verbose_name='Связанные ингредиенты'),
        ),
        migrations.AddConstraint(
            model_name='recipe',
